<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="EditNGO.aspx.cs" Inherits="auth_Adminpanel_NGO_Management_EditNGO" %>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3"> 
                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control" TextMode="MultiLine" Height="50"></asp:TextBox>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <asp:FileUpload ID="FileUploader" runat="server" />
                                  Old Attachment:<asp:Label ID="LblImage" runat="server" Font-Bold="true" 
