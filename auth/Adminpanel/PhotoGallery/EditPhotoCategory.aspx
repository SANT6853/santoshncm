<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="EditPhotoCategory.aspx.cs" Inherits="auth_Adminpanel_PhotoGallery_EditPhotoCategory" %>
                ...
                <div class="widgets-container">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Category Name
                            </label>
                            <div class="col-sm-3"> 
                            ...
                            <div class="form-group">
                            <label class="col-sm-2 control-label">Category Name in Hindi
                            </label>
                            <div class="col-sm-3"> 
