<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="ViewPhotoCategory.aspx.cs" Inherits="auth_Adminpanel_PhotoGallery_ViewPhotoCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" Runat="Server">
       <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            TotalChkBx = parseInt('<%= this.grdCategory.Rows.Count %>');
        ...
        function HeaderClick(CheckBox) {
            ...
            var TargetBaseControl = document.getElementById('<%= this.grdCategory.ClientID %>');
 ...
 <div class="row">
	...
	<div class="col-lg-12">
								...
								<div class="ibox-content collapse in">
									<div class="widgets-container">
                                       ...
                                       <div class="form-group">
                                         ...
                                         <div class="col-md-10">
                                         <div class="form-group">
											<div class="col-md-5 input-group pdd5">
            ...
            ToolTip="Click To Search" />
                 ...
                 <asp:GridView ID="grdCategory" DataKeyNames="TempCategoryId" runat="server" AutoGenerateColumns="False"
                CssClass="table table-bordered table-hover" OnRowCommand="grdCategory_RowCommand" OnRowDeleting="grdCategory_RowDeleting"
                OnRowEditing="grdCategory_RowEditing" 
                OnRowCreated="grdCategory_RowCreated">
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                             <a href="EditPhotoCategory.aspx?id=<%# DataBinder.Eval(Container.DataItem, "TempCategoryId") %>&Status=<%# DataBinder.Eval(Container.DataItem, "StatusId") %>" >
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgDelete" runat="server" OnClientClick="return confirm('Are you sure you want delete?');"
                                CommandName="Delete" ImageUrl="~/Auth/AdminPanel/images/cross.png" CommandArgument='<%# Eval("TempCategoryId") %>'
                    ...
                    <asp:TemplateField Visible="false">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblMCategory_ID" runat="server" Text='<%#Eval("TempCategoryId")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
