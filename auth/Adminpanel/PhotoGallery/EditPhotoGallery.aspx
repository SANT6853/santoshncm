<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="EditPhotoGallery.aspx.cs" Inherits="auth_Adminpanel_PhotoGallery_EditPhotoGallery" %>
                ...
                <div class="widgets-container">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Select Photo Category</label>
                            <div class="col-sm-3">
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Photo Name
                            </label>
                            <div class="col-sm-3"> 
                            ...
                            <div class="form-group">
                            <label class="col-sm-2 control-label">Photo Name in Hindi
                            </label>
                            <div class="col-sm-3"> 
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Photo Description
                            </label>
                            <div class="col-sm-3"> 
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Photo Description in Hindi
                            </label>
                            <div class="col-sm-3"> 
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Photo Alt Tag
                            </label>
                            <div class="col-sm-3"> 
                  ...
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ErrorMessage="Min 4 Character, special charecter number Not allow"
                    ControlToValidate="txtAlttag" ValidationGroup="val"  ValidationExpression="[A-Za-z][A-Za-z ]{3,1000}"></asp:RegularExpressionValidator>
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Photo Alt Tag in Hindi
                            </label>
                            <div class="col-sm-3"> 
                    ...
                    ControlToValidate="txtAlttagHindi" ValidationGroup="val"  ValidationExpression="[A-Za-z][A-Za-z ]{3,1000}"></asp:RegularExpressionValidator>
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-3"> 
                                ...
                                Old Image:<asp:Label ID="LblImage" runat="server" Font-Bold="true" 
