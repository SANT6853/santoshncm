...
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" runat="Server">
  <%--<asp:UpdatePanel ID="updatepnl" runat="server"><ContentTemplate>--%>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary1" style="margin-bottom: 25px; margin-top: 20px;">
            <div class="stpdiv"> <span class="box-title stp1 stepArrow">Step-1</span> <span class="box-title stp1 stepArrow ">Step-2</span> <span class="box-title stp1 stepArrow stepActive">Step-3</span> <span class="box-title stp1 stepArrow">Step-4</span> <span class="box-title stp1 stepArrow">Step-5</span> <span class="box-title stp" style="color: #005529; float: right;">Total Steps - 5</span> </div>
          ...
          <div class="col-md-12 main"> 
            ...
            <fieldset id="first">
              ...
              <div class="col-md-12">
                <div class="row"> <span class="frmheading"><strong>Survey Details</strong></span> </div>
                <div class="row mt20">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-5 input-group">
                        ...
                        <cc1:CalendarExtender ID="CalendarTxtDOB" Format="dd/MM/yyyy" TargetControlID="txtSurveyDate"
                                                    PopupButtonID="Image4" runat="server"> </cc1:CalendarExtender>
                ...
                <div class="row"> <span class="frmheading"><strong>Survey Information</strong></span> </div>
                <!--******************************-->
                <div class="row mt20">
                  <div class="col-sm-6">
                    <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4 input-group">
                        ...
                        <label id="lblRdbAccessbilityElectrif" runat="server" visible="false"> Duration of electricity in villages, households?:
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4 input-group">
                        ...
                        <label id="lblRdbAvenuesEmployment1" runat="server" visible="false"> Primary sector (Agriculture, Animal Husbandry etc):
                        ...
                        <label id="lblRdbAvenuesEmployment2" runat="server" visible="false"> Secondary Sector (Factory, manufacturing unit, food processing etc):
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4 input-group">
                        ...
                        <label id="lblRdbHumanWildlifecon" runat="server" visible="false"> Crop damage/injury/fatality:
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4 input-group">
                        ...
                        <label id="lblRdbAccessFireFodNwfps" runat="server" visible="false"> Crop damage/injury/fatality:
            ...
            <fieldset>
              ...
              <div class="col-md-12 mt20">
                <div class="row">
                  ...
                  <div class="col-md-12"> <span>Please fill the following mandatory form to proceed further.</span><br />
                    <span><strong>Compliance of the Wildlife (Protection) Act, 1972 and the Scheduled Tribes & Other Traditional Forest Dwellers (Recognition of Forest Rights) Act, 2006.</strong></span> </div>
                  <div class="">
                    <div class="col-md-12 mt20">
                      <div class="row"> <span class="frmheading"><strong>1.Core or Critical Tiger Habitat (CTH)</strong></span> </div>
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Notified<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                        ...
                        <div class="col-md-10 mt20" id="dvTxtDateNotification1_b">
                          <label class="col-sm-4 control-label"> Date of Notification<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                                            TargetControlID="TxtDateNotification1_b"> </cc1:CalendarExtender>
                          </div>
                        </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Area(Ha.)<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            <asp:TextBox ID="TxtAreaHa1_c" runat="server" CssClass="form-control" autocomplete="off" MaxLength="15"></asp:TextBox>
                          </div>
                        </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Compliance of section 38V of the Wildlife	(Protection) Act, 1972<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            <asp:TextBox ID="TxtCompliance1_d" runat="server" CssClass="form-control" autocomplete="off" MaxLength="100"></asp:TextBox>
                          </div>
                        </div>
                      </div>
                      <div class="row mt20"> <span class="frmheading"><strong>2.Buffer or Peripheral Area</strong></span> </div>
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Notified<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                        ...
                        <div class="col-md-10 mt20" id="DvDateNotification2_b">
                          ...
                          <div class="form-group col-md-5">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                                                            TargetControlID="TxtDateNotification2_b"> </cc1:CalendarExtender>
                          </div>
                        </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Area(Ha.)<span class="red-text">*</span> </label>
                        ...
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Expert Committee (Constituted)<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                        ...
                        <div class="col-md-10 mt20" id="DvDdlExpertCommittee2_d">
                          <label class="col-sm-4 control-label"> Date of Constitution <span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            <%--<input name="DateNotification" id="DateNotification" runat="server" class=" form-control" type="date">--%>
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Format="dd/MM/yyyy"
                                                            TargetControlID="TxtDateConstitution2_e"> </cc1:CalendarExtender>
                          </div>
                        </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Consultation With Gram Sabha<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                        ...
                        <div class="col-md-10 mt20" id="DvDdlConsultationGramSabha2_f">
                          <label class="col-sm-4 control-label"> Name of Gram Sabha<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                      ...
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> <strong>Map of CTH & Buffer or Peripheral Area.<span style="color: green; font-weight: bolder;">(jpg or .pdf files only)</span></strong> </label>
                        ...
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> <strong>Upload file </strong> </label>
                          <div class="form-group col-md-5">
                            <asp:FileUpload ID="FileUploadUploadfile2_i" runat="server" CssClass="form-control" />
                            <asp:Label ID="lbl1" Visible="false" runat="server"></asp:Label>
                            <br />
                            <span style="color: green; font-weight: bolder;">(pdf files only)</span> <br />
                        ...
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> <strong>Upload file </strong> </label>
                          <div class="form-group col-md-5">
                            <asp:FileUpload ID="FileUploadUploadfile2_j" CssClass="form-control" runat="server" />
                            <asp:Label ID="lbl2" Visible="false" runat="server"></asp:Label>
                            <br />
                            <span style="color: green; font-weight: bolder;">(pdf files only)</span> <br />
                      ...
                      <!--END OF ROW-->
                      <div class="row mt20"> <span class="frmheading"><strong>3.Recognition / Determination/ Acquisition / Vesting of Forest Rights of Schedule Tribes & such other Traditional Forest Dwellers</strong></span> </div>
                      <!--END OF ROW-->
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Completed <span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <asp:FileUpload ID="FileUploadCompleted3_a" runat="server" CssClass="form-control" ToolTip="(Upload only pdf!.)" />
                            </span> <br />
                      ...
                      <!--END OF ROW-->
                      <div class="row mt20"> <span class="frmheading"><strong>4.Re-settlement or Alternative Package</strong></span> </div>
                      <!--END OF ROW-->
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Provided <span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                      ...
                      <!--END OF ROW-->
                      <div class="row mt20"> <span class="frmheading"><strong>5.Free informed consent of Gram Sabha to the Resettlement Programme</strong></span> </div>
                      <!--END OF ROW-->
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Obtained <span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                      ...
                      <!--END OF ROW-->
                      <div class="row mt20"> <span class="frmheading"><strong>6.Voluntary consent of individuals affected</strong></span> </div>
                      <!--END OF ROW-->
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Obtained <span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <asp:FileUpload ID="FileUpload6_a" runat="server" CssClass="form-control" ToolTip="(Upload only pdf!.)" />
                            </span> </div>
                        </div>
                        <div class="col-md-10 ">
                          <label class="col-sm-4 control-label"></label>
                          <div class="form-group col-md-5">
                            <input id="Button2" type="button"  value="add multiple file upload" onClick="AddFileUpload1()" class="btn btn-success btn-xs sml-btn" />
                          </div>
                        </div>
                        <div class="col-md-10 ">
                          <label class="col-sm-4 control-label"></label>
                      ...
                      <div class="row mt20"> <span class="frmheading"><strong>7.Facilities & Land Allocation At The Resettlement Location</strong></span> </div>
                      <!--END OF ROW-->
                      <div class="row">
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Provided <span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <asp:FileUpload ID="FileUploadProvided7_a" CssClass="form-control" runat="server" />
                            </span> <br />
                            <span style="color: green; font-weight: bolder;">(pdf files only)</span>
                      ...
                      <!--END OF ROW-->
                      <div class="row mt20"> <span class="frmheading"><strong>8.Sub-divisional, District and State – level committees for monitoring of Voluntary village relocation process & grievance redressal</strong></span> </div>
                      <!--END OF ROW-->
                      <div class="row">
                        <div class="col-md-12 mt20"> <span class="frmsubheading"><strong>Sub Divisional Level Committee</strong></span> </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Constituted<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <asp:FileUpload ID="FileUpload8_a_a" runat="server" CssClass="form-control" ToolTip="(Upload only pdf!.)" />
                            </span> <br />
                            <span style="color: green; font-weight: bolder;">(pdf files only)</span>
                        ...
                        <div class="col-md-10 mt20" id="DvTxtDateofconstitution8_a_b">
                          <label class="col-sm-4 control-label"> Date of constitution </label>
                          <div class="form-group col-md-5">
                            <%--<input name="DateNotification" id="DateNotification" runat="server" class=" form-control" type="date">--%>
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender4" runat="server" Format="dd/MM/yyyy"
                                                            TargetControlID="TxtDateofconstitution8_a_b"> </cc1:CalendarExtender>
                          </div>
                        </div>
                        <div class="col-md-12 mt20"> <span class="frmsubheading"><strong>District Level Committee</strong></span> </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Constituted<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <asp:FileUpload ID="FileUpload8_b_a" CssClass="form-control" runat="server" ToolTip="(Upload only pdf!.)" />
                            </span> <br />
                            <span style="color: green; font-weight: bolder;">(pdf files only)</span>
                        ...
                        <div class="col-md-10 mt20" id="DvTxtDateofconstitution8_b_b">
                          ...
                          <div class="form-group col-md-5">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender5" runat="server" Format="dd/MM/yyyy"
                                                            TargetControlID="TxtDateofconstitution8_b_b"> </cc1:CalendarExtender>
                          </div>
                        </div>
                        <div class="col-md-12 mt20"> <span class="frmsubheading"><strong>State Level Monitoring Committee</strong></span> </div>
                        <div class="col-md-10 mt20">
                          <label class="col-sm-4 control-label"> Constituted<span class="red-text">*</span> </label>
                          <div class="form-group col-md-5">
                            ...
                            <asp:FileUpload ID="FileUpload8_c_a" runat="server" CssClass="file-path validate form-control" ToolTip="(Upload only pdf!.)" />
                            </span> <br />
                            <span style="color: green; font-weight: bolder;">(pdf files only)</span>
                        ...
                        <div class="col-md-10 mt20" id="dvTxtDateofconstitution8_c_b">
                          ...
                          <div class="form-group col-md-5">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender6" runat="server" Format="dd/MM/yyyy"
                                                            TargetControlID="TxtDateofconstitution8_c_b"> </cc1:CalendarExtender>
                          </div>
                        </div>
                      </div>
            ...
            <fieldset>
              ...
              <div class="col-md-12 mt20 form-horizontal">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">Whether Core/critical tiger habitat has been notified by the State as per Section 38V of the Wildlife Act? (If so, please enclose a copy of the notification)</label>
                    ...
                    <div id="divCheckItems1"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">Whether consent of Individual family obtained? </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <asp:RadioButtonList ID="RdbCheckItems2" RepeatDirection="Horizontal" runat="server" Width="36%">
                        <asp:ListItem Text="Yes" Selected="True" Value="Yes"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                      </asp:RadioButtonList>
                      <div id="divCheckItems2"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">Whether process of recognition and determination of rights and acquisition of land or forests rights of the Scheduled Tribes and other forests dwellers are settled? </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <asp:RadioButtonList ID="RdbCheckItems3" RepeatDirection="Horizontal" runat="server" Width="36%">
                        <asp:ListItem Text="Yes" Selected="True" Value="Yes"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                      </asp:RadioButtonList>
                      <div id="divCheckItems3"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">Whether provisions of the ST & OFD (Recognition of Forests Rights) Act, 1972 and the Scheduled Tribes & Other Traditional Forest Dwellers (Recognition of Forest Rights) Act, 2006.</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <asp:RadioButtonList ID="RdbCheckItems4" RepeatDirection="Horizontal" runat="server" Width="36%">
                        <asp:ListItem Text="Yes" Selected="True" Value="Yes"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                      </asp:RadioButtonList>
                      <div id="divCheckItems4"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">Whether District Level & State Level Monitoring Committees have been constituted?</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <asp:RadioButtonList ID="RdbCheckItems5" RepeatDirection="Horizontal" runat="server" Width="36%">
                        <asp:ListItem Text="Yes" Selected="True" Value="Yes"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                      </asp:RadioButtonList>
                      <div id="divCheckItems5"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">What is the cut of date as decided by the Competent Authority,  "for deciding the eligibility criteria" </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <asp:RadioButtonList ID="RdbCheckItems6" Visible="false" RepeatDirection="Horizontal" Width="36%" runat="server">
                        <asp:ListItem Text="Yes" Selected="True" Value="Yes"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                      </asp:RadioButtonList>
                      <div id="divCheckItems6"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
                        ...
                        <br />
                        <span style="color: green; font-weight: bolder;">(pdf files only)</span> </span> </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">Whether clearance under the Forest (Conservation) Act obtained in case of resettlement to forest land?</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <asp:RadioButtonList ID="RdbCheckItems7" RepeatDirection="Horizontal" runat="server" Width="36%">
                        <asp:ListItem Text="Yes" Selected="True" Value="Yes"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                      </asp:RadioButtonList>
                      <div id="divCheckItems7"> <span> <span style="font-weight: bold;">Remarks:</span> <br />
              ...
              <div class="col-md-12 mt20" style="padding-left: 0;">
                <div class="row">
                  ...
                  <div class="col-md-10" style="display:none;">
                    <label class="col-sm-4 control-label"> Token/Ticket Id(Generate automatic): </label>
                    <div class="form-group col-md-5"> <span id="" style="color: Green; font-weight: bold;">
                      <asp:Label ID="LblTokenID" runat="server" ForeColor="Green" Font-Bold="true"></asp:Label>
                      </span> </div>
                  </div>
                  <div class="col-md-10" style="display:none;">
                    <label class="col-sm-4 control-label"> Select Village Name <span class="red-text">*</span>: </label>
                    <div class="form-group col-md-5">
                      <asp:DropDownList ID="ddlselectname" runat="server" CssClass="form-control" Width="250px"> </asp:DropDownList>
                    </div>
                  </div>
                  <div class="col-md-10" style="display:none;">
                    <label class="col-sm-4 control-label"> Amount <span class="red-text">*</span>: </label>
                    <div class="form-group col-md-5">
                      <asp:TextBox ID="txtamount" runat="server" CssClass="form-control" autocomplete="off" MaxLength="100" Width="250px" />
                    </div>
                  </div>
                  <div class="col-md-10" style="display:none;">
                    <label class="col-sm-4 control-label"> Description <span class="red-text">*</span>:</label>
                    <div class="form-group col-md-5">
