...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        ...
        .display_inline {
            ...
            .display_inline input[type=submit],
            .display_inline input[type=button] {
                margin: 0;
            }
    ...
    <script type="text/javascript">
        ...
        function validationPage() {
            ...
            var check = $("#contentbody_chbDeclaration").is(":checked");


            if (check == true) {
                document.getElementById('dvMsgCheckBox').style.display = "none";
                condition = true;
            }
            else if (check == false) {
                document.getElementById('dvMsgCheckBox').style.display = "block";
                condition = false;
            }
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("[id*=chbDeclaration]").on('click', function () {
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 main">
                                ...
                                <asp:UpdatePanel ID="updatepnl" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="" class="col-sm-6">Access  to road (Kaccha/Pucca)<span class="red">*</span></label>
                                                    <div class="col-sm-4 input-group">
                                                        <label class="radio-inline">
                                                        ...
                                                        <label>
                                                            <asp:TextBox ID="TxtAccessibiliyRoad" Style="display: none;" Visible="false" CssClass="form-control" runat="server" placeholder="How far?"></asp:TextBox>
                                                        </label>
                        ...
                        <fieldset id="third">
                            ...
                            <div class="col-md-12 mt20">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td>Whether clearance under the Forest (Conservation) Act 1980 obtained in case of resettlement to forest land?</td>
                                            <td>
                            ...
                            <div class="col-md-12 mt20" style="padding-left: 0; position: relative; bottom: 10px; font-size: 14px; left: 15px;">
                                <div class="row">
                                  ...
                                  <asp:CheckBox ID="chbDeclaration" CssClass="pull-left" runat="server" />
                            <span style="padding-left:4px;">Information filled have been verified and found correct</span><span class="red-text">*</span>
                                (Created By: <asp:Label ID="lblUserName" runat="server" Font-Bold="true"></asp:Label>)
                           <div id="dvMsgCheckBox" style="font-size: 8pt; color: red; font-family: Verdana; display: none;">
                            Please select declaration check box. 
                            </div>
                            ...
                            <div class="col-md-12 display_inline">
                                ...
                                <div id="divSubmit" class="pull-left display_inline" runat="server" visible="false">
                                    <asp:Button ID="btnsumbit" runat="server" Text="Save & Next" ValidationGroup="val"
