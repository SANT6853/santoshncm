<%@ Page Title="NTCA:Reply Process managment" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="ReplyDfo.aspx.cs" Inherits="auth_Adminpanel_ProcessManegment_DfoUser_ReplyDfo" %>
                            ...
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group col-md-8">
                                            <asp:Label ID="lblAcceptedAmount" runat="server" Text=""></asp:Label>
