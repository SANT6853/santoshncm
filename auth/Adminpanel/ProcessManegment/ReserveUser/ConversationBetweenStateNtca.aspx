<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="ConversationBetweenStateNtca.aspx.cs" Inherits="auth_Adminpanel_ProcessManegment_ReserveUser_ConversationBetweenStateNtca" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function ConfirmOnDelete(item) {
            if (confirm("Are you sure want to BACK to this TokenId " + item + "?") == true)
                return true;
            else
                return false;
        }
        function UpdateStatus(item) {
            if (confirm("Are you sure want to UPDATE STATUS OF RESERVE USER to this TokenId " + item + "?") == true)
                return true;
            else
                return false;
        }
			 ...
			 <div class="widgets-container">
				<div class="box box-primary1" style="margin-bottom: 25px;">
                    <div class="box-header with-border">
                        <h3 class="box-title" style="color: #005529;"> CONVERSATION WITH NTCA.</h3>
                    </div>
                            ...
                            <div class="">
                                ...
                                <asp:DropDownList ID="DDlStatus" runat="server" CssClass="form-control" Width="250px">
                                    ...
                                    <asp:ListItem Text="Rejected" Value="4"></asp:ListItem>
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Status">
                                                                                <ItemTemplate>
                                                                                   ...
                                                                                   <%-- <asp:HiddenField ID="hydForwardToStateUserID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ForwardToStateUserID")%>' />
                                                                                    <asp:HiddenField ID="HydForwardToStateUserName" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ForwardToStateUserName")%>' />--%>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LblappliedBy" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FromPersonUserName")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:Button ID="BtnReplyToDfoUser" runat="server" CssClass="btn aqua" Text="Reply" CommandName="rep" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToStateAutoID") %>' />
                                                                                    <asp:Button ID="BtnRequestToStateUser" runat="server" CssClass="btn aqua" Text="Back" CommandName="Back" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToStateAutoID") %>' />
                                                                                    <asp:HiddenField ID="HydTblFromReserveToDfoAutoIDStateForwardedRowID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToDfoAutoIDStateForwardedRowID")%>' />
                                                                                     <asp:HiddenField ID="HYdForwardToNtcaUserID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ForwardToNtcaUserID")%>' />
                                                                                    <asp:Label ID="LblActionMsg" runat="server"></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                              <asp:TemplateField HeaderText="Initial amount Requested by Reserve user Name">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="LblRequestedBy" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FromPersonUserNameReserveUser")%>'></asp:Label>
                                                                                <asp:Button ID="BtnUpdateSatusRequestedUser" runat="server" CssClass="btn aqua" Text="Please Update Status of RESERVE USER(Already Action has done by NTCA)" CommandName="UpdateStatus" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToStateAutoID") %>' />
                                                                                       <asp:Label ID="LblActionMsgUpdateStatus" runat="server"></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="View Legal form/Form1">
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="BtnEditLegalFormForm1" runat="server" CssClass="btn aqua" Text="View Legal form/Form1" CommandName="legal" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TokenId_FirstTimeInsertNoChange") %>' />
