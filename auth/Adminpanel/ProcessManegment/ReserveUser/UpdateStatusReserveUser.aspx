<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="UpdateStatusReserveUser.aspx.cs" Inherits="auth_Adminpanel_ProcessManegment_ReserveUser_UpdateStatusReserveUser" %>
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                    <label class="col-sm-2 control-label">
                                       Status:</label>
                                    <div class="form-group col-md-8">
                                          <asp:DropDownList ID="DDlStatus" runat="server" CssClass="form-control" Width="250px" Enabled="False">
