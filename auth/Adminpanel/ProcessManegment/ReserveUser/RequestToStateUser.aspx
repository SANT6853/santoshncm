<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="RequestToStateUser.aspx.cs" Inherits="auth_Adminpanel_ProcessManegment_ReserveUser_RequestToStateUser" %>
                    ...
                    <div class="col-lg-12 top20 bottom40">
                        ...
                        <div class="widgets-container">
                            ...
                            <div class="row">
                               ...
                               <%-- <div class="col-md-12" style="display:none;">
                                    <label class="col-sm-2 control-label">
                                      Accepted Amount in(Rs):</label>
                                    <div class="form-group col-md-8">
                                      
                                       <asp:TextBox ID="txtAcceptedAmount" runat="server" CssClass="form-control" autocomplete="off" MaxLength="10" />
                              ...
                              <%--  <div class="col-md-12">
                                ...
                                <div class="col-md-6 pull-right">
                                    <asp:Button ID="btnsumbit" runat="server" Text="Request" ValidationGroup="val"
