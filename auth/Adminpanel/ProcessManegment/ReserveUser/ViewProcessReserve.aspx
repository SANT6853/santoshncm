<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="ViewProcessReserve.aspx.cs" Inherits="auth_Adminpanel_ProcessManegment_ReserveUser_ViewProcessReserve" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function ConfirmOnDelete(item) {
            if (confirm("Are you sure REQUEST to NTCA of this TokenId: " + item + "?") == true)
                return true;
            else
                return false;
        }
                    ...
                    <div class="widgets-container">
                        ...
                        <div class="box box-primary1" style="margin-bottom: 25px;">
                            <div class="box-header with-border">
                                <h3 class="box-title" style="color: #005529;">CONVERSATION WITH RESERVE</h3>
                            </div>
                        </div>
                                                                    ...
                                                                    <asp:GridView ID="GrdDfoReserve" ShowFooter="true" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" runat="server" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Vertical" ForeColor="Black" OnPageIndexChanging="GrdDfoReserve_PageIndexChanging" OnRowCommand="GrdDfoReserve_RowCommand" OnRowDeleting="GrdDfoReserve_RowDeleting" OnRowDataBound="GrdDfoReserve_RowDataBound">
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="S.No">
                                                                                <ItemTemplate>
                                                                                   <%-- testing purpose id:<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToDfoAutoID") %>--%>
                                                                                    <br /><asp:Label ID="lblsno" runat="server" Text='<%#Container.DataItemIndex+1 %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LblappliedBy" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FromPersonUserName")%>'></asp:Label>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="BtnReplyToDfoUser" runat="server" CssClass="btn aqua" Text="Reply" CommandName="rep" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToDfoAutoID") %>' />
                                                                                    <asp:Button ID="BtnRequestToStateUser" runat="server" CssClass="btn aqua" Text="Request to NTCA" CommandName="reqstate" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToDfoAutoID") %>' />

                                                                                    <asp:Label ID="LblActionMsg" runat="server"></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Amount Requested of Reserve user Name">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="LblRequestedBy" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FromPersonUserName")%>'></asp:Label>
                                                                                    <%-- <asp:Button ID="BtnUpdateSatusRequestedUser" runat="server" CssClass="btn aqua" Text="Update Status" CommandName="UpdateStatus" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TblFromReserveToDfoAutoID") %>' />
