...
public partial class auth_Adminpanel_ProcessManegment_ReserveUser_ReplyFromStateToNtca : CrsfBase
{
    //-------------
    ...
    void ReplyCode()
    {
        ...
        _tigerReserverBl.InsertStateToNtcaRelpy(_TigerReserveOB);
