...
public partial class auth_Adminpanel_ProcessManegment_ReserveUser_ViewProcessReserve :CrsfBase
{
    ...
    void BindDfoReserveProcess()
    {
        ...
        P_var.dSet = _tigerReserverBl.GetNtcaStateProcessDal(_TigerReserveOB);
            ...
            if (Session["CurrentRequestUrl"] != null && Convert.ToString(Session["CurrentRequestUrl"]).Equals(Convert.ToString(Request.ServerVariables["HTTP_REFERER"])))
            {
                if (CurrentSessionId == hdnblank)
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        {
                            int TblFromStateToReserveAutoID = Convert.ToInt32(e.CommandArgument);
                            Response.Redirect("~/Auth/AdminPanel/ProcessManegment/NtcaUser/ReplyFromReserveToDfo.aspx?TblFromStateToReserveAutoID=" + TblFromStateToReserveAutoID, false);
                        ...
                        if (e.CommandName == "history")
                        {
                            ...
                            Response.Redirect("~/Auth/AdminPanel/ProcessManegment/NtcaUser/ReserveHistory.aspx?tokenID=" + tokenID, false);
                        ...
                        {//LblTokenID
                            ...
                            else
                            {
                                LblMsg.Text = string.Empty;
                                int TblFromStateToReserveAutoID = Convert.ToInt32(e.CommandArgument);
                                Response.Redirect("~/Auth/AdminPanel/ProcessManegment/NtcaUser/RequestToStateUser.aspx?TblFromStateToReserveAutoID=" + TblFromStateToReserveAutoID, false);
                            }
                        ...
                        if (e.CommandName == "legal")
                        {
                            ...
                            Response.Redirect("~/Auth/AdminPanel/ProcessManegment/DfoUser/ViewLegalForm.aspx?TblFromDfoToReserveAutoID=" + TblFromDfoToReserveAutoID + "&chk=super", false);
