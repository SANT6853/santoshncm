...
public partial class auth_Adminpanel_CMS_EditContent : CrsfBase
{
                ...
                if (CurrentSessionId == hdnblank)
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        if (p_Var.dSet.Tables[0].Rows.Count > 0)
                        {
                            ...
                            txtLinkUrl.Text = HttpUtility.HtmlDecode(p_Var.dSet.Tables[0].Rows[0]["UrlName"].ToString());
                            ...
                            if (ddlMenuType.SelectedValue == "2")
                            {
                                txtUrlName.Text = HttpUtility.HtmlDecode(p_Var.dSet.Tables[0].Rows[0]["Url"].ToString());
                            }
                            else
                            {
                ...
                if (CurrentSessionId == hdnblank)
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        if (Session["Status_Id"] != null)
                        {
                            ...
                            {
                                contentObject.StatusID = (int)Module_ID_Enum.Module_Status_ID.draft;
                            }
                            else
                            {
                        ...
                        else if (ddlMenuType.SelectedValue == "2")
                        {
                            ...
                            contentObject.Url = HttpUtility.HtmlEncode(txtLinkUrl.Text.Trim());
                        }
                        //start naren1june
