<%@ Page Title="Delete menu:NTCA" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="DeletedContent.aspx.cs" Inherits="auth_Adminpanel_CMS_DeletedContent" %>
            ...
            <div class="col-lg-12 top20 bottom20">
                <div class="widgets-container">
                    ...
                    <div class="form-horizontal">
                      ...
                      <%--  <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtMenuName" runat="server" CssClass="form-control" MaxLength="50" Enabled="False"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <asp:DropDownList ID="ddlMenuType" runat="server" CssClass="form-control" Enabled="False">
                         ...
                         <div class="form-group" id="divLink" runat="server" visible="false">
                            ...
                            <div class="col-sm-3"> 
                                 <asp:TextBox ID="txtLinkUrl" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                  ...
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ErrorMessage="Enter only alphanumeric values,don't use any special character even space."
                    ...
                    <div class="col-sm-3">
                       <asp:FileUpload ID="fileUpload_Menu" runat="server" Visible="False" />
            ...
            ControlToValidate="fileUpload_Menu" ErrorMessage="File Required!" Display="Dynamic" ValidationGroup="val" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <div class="clear"></div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3"> 
                                <asp:TextBox ID="txtPageTitle" runat="server" CssClass="form-control" MaxLength="50" Enabled="False"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3"> 
                                <asp:TextBox ID="txtBrowserTitle" runat="server" CssClass="form-control" MaxLength="50" Enabled="False" ></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3"> 
                                <asp:TextBox ID="txtUrlName"  runat="server" MaxLength="50" CssClass="form-control" Enabled="False" />
                ...
                CssClass="redtext" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3"> 
                                <asp:DropDownList ID="ddlMetaLang" runat="server" CssClass="form-control" Enabled="False">
                         ...
                         <div class="form-group" id="divContent" runat="server">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <asp:Button ID="btnsave" runat="server" ValidationGroup="val" Text="Delete Record" OnClientClick="return confirm('Are You sure want to Delete?');" CssClass="btn aqua" OnClick="btnsave_Click" />
