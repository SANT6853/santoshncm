...
public partial class auth_Adminpanel_NGO_Ngoreport : CrsfBase
{
    ...
    public void bindngoNTCA()
    {
        ...
        DataSet ds = bal.Showrecord11(Convert.ToInt32(ddlselectreserve.SelectedValue));
        if (ds.Tables[0].Rows.Count > 0)
        {
            gvforngo.DataSource = ds;
            ViewState["Data"] = ds;
