<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="NGO.aspx.cs" Inherits="auth_Adminpanel_NGO" %>
						...
						<div class="form-horizontal">
							<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
										<asp:DropDownList ID="ddlserchngo" runat="server" CssClass="form-control" AutoPostBack="True"
                            OnSelectedIndexChanged="ddlserchngo_SelectedIndexChanged">
								</asp:DropDownList>
								</div>
								<div class="col-sm-3">
							...
							<div class="col-md-6 ">
								<a href="http://45.115.99.199/NTCA_MIS/auth/adminpanel/NGO/Associate_Village1.aspx" class="btn btn-primary btn-add pull-right ">Associated NGO</a>&nbsp;&nbsp;
			...
			<div class="col-md-12 mt30">
								<table class="table table-bordered table-stripped">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td><a href="http://45.115.99.199/NTCA_MIS/auth/adminpanel/ConversionScheme/AddConversionScheme.aspx" target="_blank">(Name & Details)</a></td>
											<td><a href="http://45.115.99.199/NTCA_MIS/auth/adminpanel/village-preview.aspx" target="_blank">5</a></td>
											<td>1,50,000</td>
											<td><a href="http://45.115.99.199/NTCA_MIS/auth/adminpanel/NGOPreview.aspx" target="_blank">6</a></td>
											<td>2,50,000</td>
											<td>Yes</td>
