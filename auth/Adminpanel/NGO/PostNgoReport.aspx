<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" CodeFile="PostNgoReport.aspx.cs" Inherits="auth_Adminpanel_NGO_PostNgoReport" %>
        ...
        <div class="inner-content-right">
			<div class="box box-primary1" style="margin-bottom: 25px;">
                            <div class="box-header with-border">
                                <h3 class="box-title" style="color: #005529;">NGO POST Monitoring Report</h3>
                            </div>
            ...
            <table width="100%" class="table-2">
                <asp:Panel ID="panelprint" runat="server">
                    <tr>
                        <td>
                            <asp:GridView ID="gvforngo" runat="server" AllowPaging="True" DataKeyNames="id"
                                OnPageIndexChanging="gvforngo_PageIndexChanging" PageSize="10"
                                AutoGenerateColumns="False"
                                CellPadding="1" CellSpacing="1" RowStyle-Wrap="true"
                                            ...
                                            <asp:GridView ID="grdvillage" AutoGenerateColumns="false" runat="server" CssClass="mGrid table table-bordered table-striped">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="NGO Name">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "NGO_NAME")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Work Done">
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "NGO_Work")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Address">
                                                     ...
                                                     <asp:TemplateField HeaderText="Registration No">
                                                        <ItemStyle Width="100%" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <%#DataBinder.Eval(Container.DataItem, "Rgistration")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                    ...
                    <tr>
                        <td align="center">
                            <%-- <h4> <span style="color:Red;">*</span>  &nbsp; <b>source from <%=Session["sTigerReserveName"].ToString() %></b> </h4>--%>
