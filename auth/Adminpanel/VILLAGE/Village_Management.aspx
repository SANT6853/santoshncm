...
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" runat="Server">
  ...
  <div style="float: right !important; padding: 6px;">
          ...
          <div class="table-responsive">
            ...
            <tr>
              <td colspan="3" align="center">
                  ...
                  <asp:TemplateField>
                    <HeaderTemplate> Funds Required  <i class="fa fa-inr" style="font-size:18px;" aria-hidden="true"></i> </HeaderTemplate>
                    <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="View Map">
                    ...
                    <ItemTemplate> <strong>
                      ...
                      <asp:TemplateField HeaderText="KML/KMZ File">
                    <ItemStyle HorizontalAlign="Center" />
                    <ItemTemplate> <strong>
                     <%-- <asp:ImageButton ID="viewmap" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "VILL_ID") %>' CommandName="Map"
                                                                Visible="true" ImageUrl="~/auth/Adminpanel/REPORT/Gmap.ico" Width="40px" />--%>
                       
                        <a href='<%=ResolveUrl("~/WriteReadData/VILLAGE/") %><%#DataBinder.Eval(Container.DataItem,"Kmlfileupload")%>' target="_blank"><%# DataBinder.Eval(Container.DataItem, "Kmlfileupload") %></a>
                      <%--Visible='<%# DataBinder.Eval(Container.DataItem, "visible") %>'--%>
                      </strong> </ItemTemplate>
                  </asp:TemplateField>
                  </Columns>
