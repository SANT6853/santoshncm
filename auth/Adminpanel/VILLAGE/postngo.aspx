<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="postngo.aspx.cs" Inherits="auth_Adminpanel_Post_postngo" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div id="" class="form-group">
                            ...
                            <div class="controls">
                                <asp:TextBox runat="server" disabled="disabled" name="txtApplicantName" ID="txtVillage" class="textinput form-control" autocomplete="stopdoingthat"  onkeyup="myFunction()"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6 ">
            <div class="text-left mt0">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-primary" id="btnSaveRecords" >Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $("body").on("click", "#btnSaveRecords", function () {
            $.ajax({
				...
				error:function(abc){console.log(abc);
				}
            });
        });
    </script>
