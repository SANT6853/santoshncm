              ...
              <div class="form-horizontal">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12 auto-style2" id="FileUploadContainer"> <span style="font-family: Arial">Click here to upload multiple files</span>&nbsp;&nbsp;
                  ...
                  <!--  <asp:FileUpload ID="fileUpload_Menu" runat="server" ValidationGroup="GroupVmg" Visible="false"/>-->
                      ...
                      <asp:Label ID="lblmenuMsg" runat="server" Text="Current File:" Visible="False" ForeColor="Red"></asp:Label>
