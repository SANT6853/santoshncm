...
public partial class auth_Adminpanel_VILLAGE_Village_Management_Add : CrsfBase
{
                ...
                if (CurrentSessionId == hdnblank)
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        if (fileUpload_Menu.PostedFile != null && fileUpload_Menu.PostedFile.InputStream.Length != 0)
                        {
                            ...
                            if (p_Var.ext.Equals(".PDF") || p_Var.ext.Equals(".XLSX") || p_Var.ext.Equals(".DOCX") || p_Var.ext.Equals(".DOC") || p_Var.ext.Equals(".jpg") || p_Var.ext.Equals(".JPG") || p_Var.ext.Equals(".jpeg") || p_Var.ext.Equals(".JPEG") || p_Var.ext.Equals(".png") || p_Var.ext.Equals(".PNG"))
                            {
