<%@ Page Title="NTCA:Village marital Chart" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="VillageMaritalOptionBarPieChart.aspx.cs" Inherits="auth_Adminpanel_BarPieChart_VillageMaritalOptionBarPieChart" %>
      ...
      <div class="inner-content-right">
        <div class="box box-primary1 pull-left" style="margin-bottom: 25px;">
          <div class="box-header with-border full_width">
            <h3 class="box-title" style="color: #005529;">Chart Report of Village (Marital Status) Bar/pie chart Report</h3>
        ...
        <div class="form-horizontal">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="form-group">
                <label class="col-sm-5 col-md-5 col-xs-12 control-label">Select Marital status/Option wise:</label>
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <asp:DropDownList ID="DDlStatus" runat="server" CssClass="form-control">
                    ...
                    <%-- <asp:ListItem Text="I" Value="I"></asp:ListItem>
                                    ...
                                    <asp:ListItem Text="No Option" Value="No Option"></asp:ListItem>--%>
                  </asp:DropDownList>
                </div>
              </div>
            </div>
