<%@ Page Title="NTCA:Village Cast Chart" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="VillageCastBarPieChart.aspx.cs" Inherits="auth_Adminpanel_BarPieChart_VillageCastBarPieChart" %>
      ...
      <div class="inner-content-right">
        <div class="box box-primary1 pull-left" style="margin-bottom: 25px;">
          <div class="box-header with-border full_width">
            <h3 class="box-title" style="color: #005529;">Chart Report of Village Cast Bar/pie chart Report</h3>
            <a href="javascript:void(0)" onClick="printWindow()" class="btn btn-primary btn-xs pull-right">Print</a> </div>
        </div>
        <div class="form-horizontal">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <label class="col-sm-4 col-md-4 col-xs-12 control-label">Select State Name:</label>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <label class="col-sm-4 col-md-4 col-xs-12 control-label">Select Tiger reserve name:</label>
              <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <label class="col-sm-4 col-md-4 col-xs-12 control-label">Select Village name:</label>
              <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <label class="col-sm-4 col-md-4 col-xs-12 control-label">Select Cast:</label>
              <div class="col-md-8 col-sm-8 col-xs-12">
