<%@ Page Title="NTCA:Village option wise chart" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="VillageOptionBarPieChart.aspx.cs" Inherits="auth_Adminpanel_BarPieChart_VillageMaritalOptionBarPieChart" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="box box-primary1 pull-left" style="margin-bottom: 25px;">
                    <div class="box-header with-border full_width">
                        <h3 class="box-title" style="color: #005529;">Chart Report of Village option wise Bar/pie chart Report</h3>
                                ...
                                <asp:DropDownList ID="DDlStatus" runat="server" CssClass="form-control">
                                   ...
                                   <%-- <asp:ListItem Text="Single" Value="Single"></asp:ListItem>
                                    ...
                                    <asp:ListItem Text="I" Value="I"></asp:ListItem>
                                     <asp:ListItem Text="II/Lakh" Value="II"></asp:ListItem>
