<%@ Page Title="NTCA:Village Relocation Chart" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="BarPieChart.aspx.cs" Inherits="auth_Adminpanel_BarPieChart_BarPieChart" %>
  ...
  <div class="container-fluid" style="margin-bottom: 62px; background:#fff;">
    ...
    <div class="box box-primary1 pull-left" style="margin-bottom: 25px;">
          <div class="box-header with-border full_width">
            <h3 class="box-title" style="color: #005529;">Chart Report of Village Relocation status Bar/pie chart Report</h3>
