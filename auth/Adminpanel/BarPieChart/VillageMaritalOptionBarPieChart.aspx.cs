                    ...
                    if (Page.IsValid)
                    {
                        ...
                        else
                        {
                            if (DdTigerReserve.SelectedValue != "0" && DDlStatus.SelectedValue != "All")
                            {
                                ...
                                if (DDlStatus.SelectedItem.Text == "I")
                                {
                                    //  BindBarChartInProgress();
                                    // BindBarChart();
                                    BindBarChartI();
                                ...
                                if (DDlStatus.SelectedItem.Text == "II")
                                {
                                    //  BindBarChartInProgress();
                                    // BindBarChart();
                                    BindBarChartII();
                                ...
                                if (DDlStatus.SelectedItem.Text == "No Option")
                                {
                                    //  BindBarChartInProgress();
                                    // BindBarChart();
    ...
    void BindBarChart()
    {
        ...
        try
        {
            ...
            for (int i = 0; i <= dt.Rows.Count - 1; i++)
            {
                ...
                //str.Append("data.setValue(" + i + "," + 4 + "," + dt.Rows[i]["I"].ToString() + ") ;");
                //str.Append("data.setValue(" + i + "," + 5 + "," + dt.Rows[i]["II"].ToString() + ") ;");
                //str.Append("data.setValue(" + i + "," + 6 + "," + dt.Rows[i]["No Option"].ToString() + ") ;");
            }

            str.Append(" var chart = new google.visualization.ColumnChart(document.getElementById('chart_div'));");
            str.Append(" chart.draw(data,{isStacked:true, width:1000, height:550,chartArea: {left: 40,top: 10,width:" + 25 * (dt.Rows.Count) + ",height: 350}, hAxis: {showTextEvery:1, slantedText:true}});}");
