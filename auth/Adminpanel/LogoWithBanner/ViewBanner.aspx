<%@ Page Title="NTCA:View Logo Banner" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master"
      ...
      <div class="inner-content-right">
        <div class="box box-primary1" style="margin-bottom: 25px;">
          <div class="box-header with-border">
            <h3 class="box-title" style="color: #005529;">View Logo Banner List</h3>
          </div>
        </div>
        ...
        <div id="divGrid" runat="server" visible="false" class="col-md-12 col-xs-12">
          <asp:GridView ID="grdBanner" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <asp:TemplateField HeaderText="Banner Name" HeaderStyle-CssClass="Text-Center">
              <ItemTemplate> <%# DataBinder.Eval(Container.DataItem, "Image_Name")%>
