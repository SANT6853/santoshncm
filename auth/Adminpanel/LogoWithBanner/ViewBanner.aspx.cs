...
public partial class auth_Adminpanel_Banner_ViewBanner : CrsfBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                if(Request.QueryString["Mode"]=="Ed")
                {
    ...
    public void BindGrid(int statusid)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                contentObject.ModuleID = (int)Module_ID_Enum.Project_Module_ID.LogoBanner;
                // contentObject.Websiteid = Convert.ToInt32(ddlwebsite.SelectedValue);
                p_Var.dsFileName = bannerBL.GetLogoBannerData(contentObject);
                ...
                if (CurrentSessionId == hdnblank)
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        if (p_Var.Result > 0)
                        {
                            ...
                            Session["BackUrl"] = "~/Auth/AdminPanel/LogoWithBanner/ViewBanner.aspx?ModuleID=" + Convert.ToInt16(Request.QueryString["ModuleID"]);
                            Response.Redirect("~/Auth/AdminPanel/ConfirmationPage.aspx");
