<%@ Page Title="NTCA:Upload related file" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="Uploadreletedfile.aspx.cs" Inherits="auth_Adminpanel_Uploadreletedfile" %>
...
.textfield-drop{width:70%;}
 ...
 <table width="100%" align="center" cellpadding="3" cellspacing="1" class="Progress_table table-2">
  <tr>
   <td colspan="5" style="border-bottom: 3px solid #005529; padding-left:0px; padding-bottom:0px;"><h3 style="color: #005529;">Upload Related files for village</h3></td>
