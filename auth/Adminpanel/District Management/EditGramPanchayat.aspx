<%@ Page Title="NTCA:Edit Grampanchayat" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="EditGramPanchayat.aspx.cs" Inherits="auth_Adminpanel_District_Management_EditGramPanchayat" %>
            ...
            <div class="col-lg-12 ">
                <div class="widgets-container">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title" style="color: #005529;">Edit Grampanchayat</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Select Tehshil</label>
                            <div class="col-sm-3">
                               <asp:DropDownList ID="ddlTehshil" runat="server" CssClass="form-control">

                               </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" Display="Dynamic" CssClass="help-block" ControlToValidate="ddlTehshil" ValidationGroup="val" 
                                    ErrorMessage="Select tehshil"  />
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Gram panchayat Name<label style="color:red;">*</label>
                            </label>
                            <div class="col-sm-3"> 
                                <asp:TextBox ID="txtGramPanchayatName" runat="server" CssClass="form-control" MaxLength="50" ValidationGroup="val"></asp:TextBox>
                                 <asp:RequiredFieldValidator runat="server" Display="Dynamic" CssClass="help-block"  ControlToValidate="txtGramPanchayatName"  ValidationGroup="val" 
                                    ErrorMessage="Please enter grampanchayat name" />
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <asp:Button ID="btnsave" runat="server" ValidationGroup="val" Text="Submit" OnClientClick="return getPass();" CssClass="btn btn-primary" OnClick="btnsave_Click" />
