<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="AddConversionScheme.aspx.cs" Inherits="auth_Adminpanel_Post_AddConversionScheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function Saverecords() {
            ...
            var App = true;
            try {
                $('[id*=txtSchemeName]').each(function () {
                ...
                $('.recordset').each(function () {
                    NGORecord.Name = $(this).find('#txtSchemeName').val();
                ...
                if (NGORecordArray.length > 0 && App == true) {
                    $.ajax({
                        type: "POST",
                        url: "AddConversionScheme.aspx/SaveRecord",
