<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="Addworkperform.aspx.cs" Inherits="auth_Adminpanel_Post_Addworkperform" %>
        ...
        function Saverecords() {
            ...
            try {
                ...
                if (NGORecordArray.length > 0 && App == true) {
                    $.ajax({
                        type: "POST",
                        url: "Addworkperform.aspx/SaveRecord",
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary1" style="margin-bottom: 25px; margin-top: 20px;">
                            <div class="box-header with-border">
                                <h3 class="box-title" style="color: #005529;">Work performed under option (II) History</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div id="" class="form-group">
                                <label for="id_stock_1_product1" class="control-label  requiredField">
                                   Executive/State Name <span class="red">* </span>
                                </label>
                                <div class="controls">
                                    <asp:TextBox disabled="disabled" ID="txtExcutive" runat="server" class="textinput form-control" autocomplete="stopdoingthat"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="recordset">
                                    <div class="fieldRow clearfix">
                                        <div class="col-md-2" style="display:none;">
                                            <div id="" class="form-group">
                                                <label for="id_stock_1_product1" class="control-label  requiredField">
                                                    Executive/State <span class="red">* </span>
                                                </label>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-3" style="display:none;">
                                            <div id="" class="form-group">
                                                ...
                                                <div class="controls ">
                                                    <input type="text" id="txtremaningBalance" class="form-control" maxlength="10" autocomplete="off" onkeypress="return validateNumber(event);">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
