...
public partial class auth_Adminpanel_Post_addpostngo : System.Web.UI.Page
{
    ...
    public void NGORecord()
    {
        ...
        {
            txtNGO.Text = p_Var.dSet.Tables[0].Rows[0]["NGO_NAME"].ToString();
    ...
    public static string SaveRecord(string NGORECORD)
    {
        ...
        if (Convert.ToInt32(HttpContext.Current.Session["ID"]) != null)
        {
            ...
            int Result = ngBL.SavePostNgoHistory(_TigerReserveOB);
