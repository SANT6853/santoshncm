...
public partial class auth_Adminpanel_BottomThumnails_ViewBottomThumnail :CrsfBase
{
                ...
                if (CurrentSessionId == hdnblank)
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        if (e.CommandName == "Delete")
                        {
                            ...
                            if (del > 0)
                            {
                                Session["msg"] = "Bottom thumnail has been deleted successfully.";
                                Session["BackUrl"] = "~/Auth/AdminPanel/BottomThumnails/ViewBottomThumnail.aspx?ModuleID=" + Convert.ToInt16(Module_ID_Enum.Project_Module_ID.MiddleContent);
                                Response.Redirect("~/Auth/AdminPanel/ConfirmationPage.aspx");
                            }
                            else
                            {
                                Session["msg"] = "Bottom thumnail has not been deleted successfully.";
                                Session["BackUrl"] = "~/Auth/AdminPanel/BottomThumnails/ViewBottomThumnail.aspx?ModuleID=" + Convert.ToInt16(Module_ID_Enum.Project_Module_ID.MiddleContent);
                                Response.Redirect("~/Auth/AdminPanel/ConfirmationPage.aspx");
                            }
                        }
    ...
    public void BindGrid(int statusid)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                contentObject.ModuleID = (int)Module_ID_Enum.Project_Module_ID.BottomThumnail;
...
//{
                            ...
                            if (p_Var.Result > 0)
                            {
                                Session["msg"] = "Bottom thumnail has been approved successfully.";
                                Session["BackUrl"] = "~/Auth/AdminPanel/BottomThumnails/ViewBottomThumnail.aspx?ModuleID=" + Convert.ToInt16(Request.QueryString["ModuleID"]);
                                Response.Redirect("~/Auth/AdminPanel/ConfirmationPage.aspx");
                            ...
                            {
                                Session["msg"] = "Bottom thumnail has not been approved successfully.";
                                Session["BackUrl"] = "~/Auth/AdminPanel/BottomThumnails/ViewBottomThumnail.aspx?ModuleID=" + Convert.ToInt16(Request.QueryString["ModuleID"]);
                                Response.Redirect("~/Auth/AdminPanel/ConfirmationPage.aspx");
                            }
                        //}
    ...
    protected void ddlwebsite_SelectedIndexChanged(object sender, EventArgs e)
    {
        if(ddlwebsite.SelectedValue=="1")
        {
            ...
            StarState.Visible = false;
        }
        else
        {
            StarReserve.Visible = true;
            StarState.Visible = true;
        }
