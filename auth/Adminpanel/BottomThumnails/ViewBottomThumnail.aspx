<%@ Page Title="NTCA:View Bottom thumnail" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master"
    AutoEventWireup="true" CodeFile="ViewBottomThumnail.aspx.cs" Inherits="auth_Adminpanel_BottomThumnails_ViewBottomThumnail" %>
      ...
      <div class="inner-content-right">
        <div class="box box-primary1" style="margin-bottom: 25px;">
          <div class="box-header with-border">
            <h3 class="box-title" style="color: #005529;">View Bottom Thumnails List</h3>
          </div>
        </div>
        <div class="form-horizontal">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label class="col-md-4 control-label"> Select State
                <asp:Label ID="StarState" runat="server" Text="*" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
              </label>
              <div class="col-md-8 input-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label class="col-md-4 control-label"> Select Tiger Reserve
                <asp:Label ID="StarReserve" runat="server" Text="*" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
              </label>
              <div class="col-md-8 input-group">
        ...
        <div id="divGrid" runat="server" visible="false" class="col-md-12 col-xs-12">
          <asp:GridView ID="grdBanner" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                OnRowCreated="grdBanner_RowCreated" OnRowDataBound="grdBanner_RowDataBound" OnRowDeleting="grdBanner_RowDeleting" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black">
            ...
            <asp:TemplateField HeaderText="Images" >
              <ItemTemplate>
                <image src="<%= ResolveUrl("~/WriteReadData/BannerImages/") %><%#Eval("Image_Name") %>"></image>
                <%-- <a href="<%= ResolveUrl("~/WriteReadData/BannerImages/") %><%#Eval("Image_Name") %>" rel="lightbox[slide]" target="_blank" class="vlightbox" caption="Title : -<%# Eval("Name") %>  Description: -<%# Eval("Name") %>">
                                            <%#Eval("Name") %> </a>--%>
                </center>
              </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Edit" HeaderStyle-CssClass="Text-Center" ItemStyle-CssClass="Text-Center">
              <ItemTemplate> <a href="BottomThumnailEdit.aspx?id=<%#DataBinder.Eval(Container.DataItem,"Temp_Link_Id")%>&statusID=<%#DataBinder.Eval(Container.DataItem,"Status_Id")%>">
