...
public partial class auth_Adminpanel_BottomThumnails_AddBottomThumnail : CrsfBase
{
    ...
    {
        Response.Redirect("~/auth/adminpanel/BottomThumnails/ViewBottomThumnail.aspx?Moduleid=" + Convert.ToInt16(Module_ID_Enum.Project_Module_ID.BottomThumnail), false);
    }
                               ...
                               // bool ChkMaliciousType = obMiscell.GetActualFileType(FileUpload1.PostedFile.InputStream);
                                ...
                                else
                                {
                                 contentObject.ImageName = null;
                                    ...
                                    if (insertdata > 0)
                                    {
                                        Session["msg"] = "Bottom thumnail has been submitted successfully.";
                                    ...
                                    {
                                        Session["msg"] = "Bottom thumnail has not been submitted successfully.";
                                        Session["BackUrl"] = "~/Auth/AdminPanel/BottomThumnails/ViewBottomThumnail.aspx?ModuleID=" + Convert.ToInt16(Module_ID_Enum.Project_Module_ID.BottomThumnail);
                                        Response.Redirect("~/Auth/AdminPanel/ConfirmationPage.aspx");
                                    }   
