<%@ Page Title="" Language="C#" MasterPageFile="~/auth/Adminpanel/Adminmaster.master" AutoEventWireup="true" CodeFile="GoogleMapFromOnly.aspx.cs" Inherits="auth_Adminpanel_REPORT_GoogleMapFromOnly" %>
        ...
        <div class="inner-content-right">
			...
			<div class="box box-primary1" style="margin-bottom: 25px;">
                    <div class="box-header with-border">
                        ...
                        <h2>NOTE :Please go to (DATAT ENTRY) menu and then click sub menu (RELOCATION SITE MANAGEMENT to update it relocation details and see after then relocated address on map.)</h2>
                    </div>                    
                </div>
			<div class="col-md-12">	
