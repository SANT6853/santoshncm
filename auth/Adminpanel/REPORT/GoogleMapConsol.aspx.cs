...
public partial class auth_Adminpanel_REPORT_GoogleMapConsol : CrsfBase
{
            ...
            if (Session["CurrentRequestUrl"] != null && Convert.ToString(Session["CurrentRequestUrl"]).Equals(Convert.ToString(Request.ServerVariables["HTTP_REFERER"])))
            {
                if (CurrentSessionId == hdnblank)
                {
                    if (Page.IsValid)
                    {
                        ...
                        Response.Redirect("~/AUTH/adminpanel/REPORT/RelocationMapGoogle.aspx?&ConsoldateStateName=" + sUrlConsoldateStateName + "&ConsoldateMode=" + sUrlConsoldateMode + "&ReserveID=" + sUrlReserveID + "&VillageID=" + sUrlVillageID + "&StateID=" + sUrlStateID + "&VillageName=" + sUrlVillageName + "&ReserveName=" + sUrlVillageName + "&IndexMode=" + Session["sPageIndex"].ToString());
                    }
                }
            }
        }
