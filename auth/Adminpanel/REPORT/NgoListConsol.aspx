<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NgoListConsol.aspx.cs" Inherits="auth_Adminpanel_REPORT_NgoListConsol" %>
                    ...
                    <div class="col-sm-12" style="overflow-x:auto;">
                        <asp:GridView ID="GridViewNarenConsoldateReport" runat="server" AutoGenerateColumns="false" CellPadding="0" ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Ngo name" HeaderStyle-CssClass="Text-Center">
                                    <ItemStyle HorizontalAlign="left" />
                                    <ItemTemplate>

                                        <b>
                                            <asp:Label ID="LblCDP_AGENCY" runat="server" Text='<%#Eval("ngoName") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Details" HeaderStyle-CssClass="Text-Center">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <b>
                                            ...
                                            <asp:LinkButton ID="LnkDetails" ForeColor="Blue" Font-Underline="true" runat="server" Text='<%#Eval("Details") %>' CommandName="Details" CommandArgument='<%#Eval("TigerReserveName")+","+ Eval("VillID")+","+ Eval("ngoID")+","+ Eval("ngoName")%>'></asp:LinkButton>
                                        </b>
                                    </ItemTemplate>
                                </asp:TemplateField>
