		...
		<div class="col-sm-12">
            <div class="inner-content-right">
                ...
                <div class="row">
                    <div class="col-md-10 mt20">
                        <label class="col-sm-4 control-label">
                            Select Report<span class="red-text">*</span>
                        </label>
                        <div class="form-group col-md-8 tblchk">
                            ...
                            <%--<asp:CheckBoxList ID="ChkReportShowHide" runat="server" RepeatDirection="Horizontal" RepeatColumns="1">
                              ...
                              <asp:CheckBoxList ID="ChkReportShowHide" runat="server"   RepeatDirection="Horizontal">
                                    <asp:ListItem Text="VILLAGE" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="FAMILY" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="CDP" Value="3" Selected="False"></asp:ListItem>
                                    <asp:ListItem Text="NGO" Value="4"></asp:ListItem>
                                    <asp:ListItem Text="RELOCATED " Value="5" Selected="False"></asp:ListItem>
                                    <asp:ListItem Text="RELOCATION SITE " Value="6" Selected="False"></asp:ListItem>
                                    <asp:ListItem Text="RELOCATION PROGRESS " Value="7" Selected="False"></asp:ListItem>
                                </asp:CheckBoxList>
                ...
                <%--<div class="row">
                    <div class="col-md-10 mt20">
                        <label class="col-sm-4 control-label">
                            Select Family head name<span class="red-text">*</span>
                        </label>
                        <div class="form-group col-md-5">
                ...
                <%--<div class="row">
                    <div class="col-md-10 mt20">
                        <label class="col-sm-4 control-label">
                            Select Family member name<span class="red-text">*</span>
                        </label>
                        <div class="form-group col-md-5">
                ...
                <%--<div class="row">
                    <div class="col-md-10 mt20">
                        <label class="col-sm-4 control-label">
                            Select Cdp Agency name<span class="red-text">*</span>
                        </label>
                        <div class="form-group col-md-5">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Benificiaries" HeaderStyle-CssClass="Text-Center">
                                ...
                                <ItemTemplate>
                                    ...
                                    <b>
                                        <asp:Label ID="LblBenificiaries" runat="server" Text='<%#Eval("NoOfBeneficary") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="(CDP)Executive Agency" HeaderStyle-CssClass="Text-Center" Visible="false">
                                <ItemStyle HorizontalAlign="center" />
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="(CDP)Allotement Amount (In Rs)" HeaderStyle-CssClass="Text-Center" Visible="false">
                                <ItemStyle HorizontalAlign="center" />
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="(CDP)Amount Used (In Rs)" HeaderStyle-CssClass="Text-Center" Visible="false">
                                <ItemStyle HorizontalAlign="center" />
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Fund Required" HeaderStyle-CssClass="Text-Center">
                                <ItemStyle HorizontalAlign="center" />
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="No of Relocated Village" HeaderStyle-CssClass="Text-Center" Visible="false">
                                <ItemStyle HorizontalAlign="center" />
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Relocation Progress Report" HeaderStyle-CssClass="Text-Center" Visible="false">
                                <ItemStyle HorizontalAlign="center" />
                                <ItemTemplate>
