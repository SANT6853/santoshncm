<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewFamilyMemberDetails.aspx.cs" Inherits="auth_Adminpanel_REPORT_ViewFamilyMemberDetails" %>
...
<head id="Head1" runat="server">
    ...
    <style>
		...
		#headdetails{overflow-x:auto;}
		#btnPrint{margin-right:3px;}
...
<body>
            ...
            <div class="" style="margin-top: 20px;">
				<div class="row">
                    <div class="col-md-12 mt20">
						...
						<asp:Button ID="btnPrint" runat="server" Text="Print" OnClick="btnPrint_Click" Width="94px" CssClass="btn btn-primary pull-right" /></span>
						<asp:Panel ID="PRINT" runat="server">
						<asp:Panel ID="panel4" Visible="false" runat="server" Width="100%">
    ...
    <td><asp:Label ID="lblcode" runat="server" CssClass="for-view-lable"></asp:Label></td>--%>
                    ...
                    <asp:Panel ID="headdetails" runat="server" Width="100%">
                        <table width="100%" style="display:none;" border="0" align="center" cellpadding="3" cellspacing="1" class="table table-bordered table-striped">
                        ...
                        CellSpacing="0"  PageSize="10" bgColor="#005529"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="18+ Required information">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <span>IFSC/PIN CODE:<strong><%#DataBinder.Eval(Container.DataItem, "IFSC")%></strong></span><span>Bank Post office Address:<strong><%#DataBinder.Eval(Container.DataItem, "BankPostOfficeAdress")%></strong></span>
                                                   <%-- <span>AADHAR NO:<br />--%>
                                                        <strong>
                    ...
                    <asp:Panel ID="Panel1"  runat="server" Width="100%">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="background-color: #005529; color: #fff; font-size: large;" align="center" width="100%"><strong>Installment Details</strong>
                                </td>
                            </tr>
                            <tr>
