...
public partial class auth_Adminpanel_REPORT_VillageSearchII_Consol :CrsfBase
{
    ...
    void GridViewNumericCalculation4(DataSet ds)
    {
        ...
        //sno
        gv_villageSearch.FooterRow.Cells[0].Text = "Total".ToString();
        ...
        gv_villageSearch.FooterRow.BackColor = System.Drawing.Color.Beige;
        //---------Population
        gv_villageSearch.FooterRow.Cells[5].Text =Population.ToString();
        ...
        gv_villageSearch.FooterRow.BackColor = System.Drawing.Color.Beige;
        //--TotalLandAreaHa
        gv_villageSearch.FooterRow.Cells[6].Text =TotalLandAreaHa.ToString();
    ...
    public void displayVillage1()
    {
        ...
        ds = RDb.DsVillageBindConsoldate(Request.QueryString["StateID"].ToString(), sLblMsgTigerReserveValue, sLblMsgVillageValue);
