<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CDP_ReportConsol.aspx.cs" Inherits="auth_Adminpanel_REPORT_CDP_ReportConsol" %>
                ...
                <div class="col-sm-12" >
                    <div class="row">
                        <div class="col-md-12 mt20">
                            <h3>Progress of work as per Community Development Program</h3>
                            <hr />
                            <div>
                    ...
                    <div class="row">
                        <asp:GridView ID="GridViewNarenConsoldateReport" runat="server" AutoGenerateColumns="false" CellPadding="0" ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Agency name" HeaderStyle-CssClass="Text-Center">
                                    <ItemStyle HorizontalAlign="left" />
                                    <ItemTemplate>

                                        <b>
                                            <asp:Label ID="LblCDP_AGENCY" runat="server" Text='<%#Eval("CDP_AGENCY") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Details" HeaderStyle-CssClass="Text-Center">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <b>
                                            ...
                                            <asp:LinkButton ID="LnkDetails" ForeColor="Blue" Font-Underline="true" runat="server" Text='<%#Eval("Details") %>' CommandName="Details" CommandArgument='<%#Eval("TigerReserveName")+","+ Eval("VILL_ID")+","+ Eval("CDP_AGENCY")%>'></asp:LinkButton>
                                        </b>
                                    </ItemTemplate>
                                </asp:TemplateField>
