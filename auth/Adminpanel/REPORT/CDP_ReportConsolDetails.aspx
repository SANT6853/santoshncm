<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CDP_ReportConsolDetails.aspx.cs" Inherits="auth_Adminpanel_REPORT_CDP_ReportConsolDetails" %>
...
<body>
    ...
    <div class="container-fluid" style="margin-top: 10px; margin-bottom: 62px; padding: 10px; background: #fff;">
        <div class="col-sm-12">
			...
			<div class="row">
                    <div class="col-md-12 mt20 pb30">
                        <h3>Progress of work as per Community Development Program(Option II)</h3>
                        <hr />
                        <div>
						<asp:Button ID="btn_print" runat="server" Text="Print" OnClick="btn_print_Click" CssClass="btn btn-primary pull-right btn-add" />
						<asp:Button ID="BtnBackConsoldateReport" Visible="false" runat="server" Text="Back" CssClass="btn btn-primary pull-right btn-add"
