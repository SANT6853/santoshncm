  ...
  <div class="container-fluid bigfacebg" style="margin-top: 10px; margin-bottom: 62px; padding: 10px 15px; ">
    <div class="">
      ...
      <div class="row nu12">
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 bxtp" style="display:none">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12 bxtp" runat="server" id="tigerboard">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12 bxtp" id="dBannerMang" runat="server" visible="false"> 
              <!-- small box -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12 bxtp" id="dPhotoGall" runat="server" visible="false"> 
              <!-- small box -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12 bxtp" id="dCdpMng" runat="server" visible="false"> 
              <!-- small box -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 bxtp"> 
              ...
              <div class="small-box bg-aqua bg-aqua-shadow hvr-grow-shadow" onclick="window.location='<%= ResolveUrl("~/auth/adminpanel/Post/survey-details.aspx") %>';">
                <div class="inner"> <a href="<%= ResolveUrl("~/auth/Adminpanel/Post/survey-details.aspx") %>">
                  <h4> Post-Voluntary Village Relocation </h4>
                  </a> </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 bxtp" style="display:none"> 
              ...
              <div class="small-box bg-green bg-green-shadow hvr-grow-shadow" onclick="window.location='<%= ResolveUrl("~/auth/adminpanel/Report/surveyreport.aspx") %>';">
                <div class="inner"> <a href="<%= ResolveUrl("~/auth/Adminpanel/Report/surveyreport.aspx") %>">
                  <h4>Survey Reports</h4>
                  </a> </div>
                <div class="icon"> <a href="<%= ResolveUrl("~/auth/Adminpanel/Report/surveyreport.aspx") %>"><i class="fa fa-file"></i></a> </div>
              </div>
            </div>
                        
            <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12 bxtp" id="dCms" runat="server" visible="false">
              <div class="small-box bg-green bg-green-shadow hvr-grow-shadow" onclick="window.location='<%= ResolveUrl("~/auth/adminpanel/CMS/AddContent.aspx?Moduleid=")%><%= Convert.ToInt16( Module_ID_Enum.Project_Module_ID.cms) %>';">
                <div class="inner"> <a href="<%= ResolveUrl("~/auth/adminpanel/CMS/AddContent.aspx?Moduleid=")%><%= Convert.ToInt16( Module_ID_Enum.Project_Module_ID.cms) %>">
                  <h4>CMS</h4>
                  </a>
                  <p></p>
                </div>
                <div class="icon"> <a href="<%= ResolveUrl("~/auth/adminpanel/CMS/AddContent.aspx?Moduleid=")%><%= Convert.ToInt16( Module_ID_Enum.Project_Module_ID.cms) %>"> <img src="images/cms.png"></a> </div>
              </div>
            </div>
              ...
              <div class="small-box bg-red bg-red-shadow hvr-grow-shadow" onclick="window.location='<%=ResolveUrl("~/auth/adminpanel/NGO/PostNgoreport.aspx") %>';">
                <div class="inner">
                  <h3><span class="counter">
                    <label id="LblPostcounter" runat="server"></label>
                    </span></h3>
        ...
        <div class="row">
          <div class="col-lg-9">
            <div class="restbodr">
              <div class="panel panel-green">
                <div class="rest1">
                  <div class="panel-heading "> <i class="fa fa-bar-chart-o fa-fw"></i>[<%=Session["sStatename"]%>] State Map </div>
                </div>
                <!-- /.panel-heading -->
          ...
          <div class="col-lg-3">
            <div class="restbodr">
              <div class="panel panel-green">
                <div class="rest1">
                  <div class="panel-heading"> <i class="fa fa-bell fa-fw"></i>Village list
                    [
