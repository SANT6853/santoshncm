<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="auth_Adminpanel_login" %>
                        ...
                        <div class="widgets-container" style="border: 10px solid #ddd">
                            ...
                            <div class="top15">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" placeholder="Password" autocomplete="off" id="txtPwd" runat="server" name="password" class="form-control">
                                </div>
                                ...
                                <a href="<%=ResolveUrl("/NTCA_MIS/Home.aspx") %>" style="color:white; text-decoration: underline;"><small>Back to Home</small></a>
                                <br />
                                <a href="ForgetPassword.aspx?Ftype=MainSite" style="red: white; text-decoration: underline;"><small>Forgot password?</small></a>
