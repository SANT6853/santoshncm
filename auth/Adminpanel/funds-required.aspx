                ...
                <div class="col-lg-12">
                    <div class="widgets-container">
                        ...
                        <div class="box box-primary1" style="margin-bottom: 25px;">
							<div class="stpdiv">
								<span class="box-title stp1" >Step-5</span>
                        ...
                        <div class="form-horizontal">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="ctl00$contentbody$ddlselectname" id="contentbody_ddlselectname" class="form-control" style="width:250px;">
							...
							<div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
										<textarea name="" rows="2" cols="20" id="" class="form-control" style="width:250px;"></textarea>
                                    </div>
                                </div>
                            </div>
							<div class="col-md-8">
