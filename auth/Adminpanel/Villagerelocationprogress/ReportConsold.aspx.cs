...
public partial class auth_Adminpanel_Villagerelocationprogress_ReportConsold : CrsfBase
{
    ...
    void BindStateNameConsolDate()
    {
        ...
        _objNtcauser.StateIDParameters = Request.QueryString["ConsoldateStateName"].ToString();
    ...
    public void bindgrid1()
    {
        ...
        ds = del.DsGetVillageProgressReportByStateID(Request.QueryString["ConsoldateStateName"].ToString());
        if (ds.Tables[0].Rows.Count > 0)
        {
...
//int NGO = 0;
    ...
    {
        Response.Redirect("~/auth/adminpanel/Report/ConsoldateReport/ConsoldateReport.aspx?IndexMode=" + Request.QueryString["IndexMode"].ToString());
    }
}