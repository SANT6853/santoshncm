<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VillageDisplay.aspx.cs" Inherits="auth_Adminpanel_FundManagement_VillageDisplay" %>
    ...
    <body class="page-header-fixed ">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper animated fadeInRight">
                <div>
                <uc1:HeadingControl ID="HeadingControl1" Heading="Village Detail" runat="server" />
                   <%-- <div class="wrapper-content1">--%>
                        ...
                        <uc1:HeadingControl ID="Familyheadeing" Heading="Family List" runat="server" />
                              <asp:Literal ID="ltrfamilytable" runat="server" ></asp:Literal>
