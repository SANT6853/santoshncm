...
public partial class ReportGP_FamilyDetail2 : System.Web.UI.Page
{
    ...
    public void GridveiwNumericColumnCalculationOptionWise(DataSet ds)
    {
        ...
        //sno
        gv_FamilySearch.FooterRow.Cells[0].Text = "Total " + sno.ToString();
        ...
        //AllottedAmountRs
        gv_FamilySearch.FooterRow.Cells[4].Text =  AllottedAmountRs.ToString();
        gv_FamilySearch.FooterRow.Cells[4].Font.Bold = true;
        gv_FamilySearch.FooterRow.Cells[4].HorizontalAlign = HorizontalAlign.Center;
        gv_FamilySearch.FooterRow.BackColor = System.Drawing.Color.Beige;
        //InstallmentAmountRs
        gv_FamilySearch.FooterRow.Cells[7].Text = InstallmentAmountRs.ToString();
    ...
    protected void gv_FamilySearch_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label restatus = e.Row.FindControl("restatus") as Label;
