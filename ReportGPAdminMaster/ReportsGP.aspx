<%@ Page Title="Reports:NTCA" Language="C#" MasterPageFile="~/Mainsite.master" AutoEventWireup="true" CodeFile="ReportsGP.aspx.cs" Inherits="ReportsGP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
		...
		/*.control-label{text-align:left !important; margin-left:15px;}*/
    </style>
                ...
                <tr class="bgtrans">
                    <td align="center">
                       ...
                       <asp:Label ID="Label3" runat="server" CssClass="for-view"></asp:Label>
                        ...
                        <div class="col-md-12">
                            <div id="DivSate" runat="server" class="col-md-6 form-group">
                                <label class="col-md-4 control-label gtx">Select State Name:</label>
                                <div class="col-md-8 input-group">
                                    <asp:DropDownList ID="DdlStateName" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="DdlStateName_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
                            <div id="DVTr" runat="server" class="col-md-6 form-group">
                                <label class="col-md-4 control-label gtx">Select Tiger Reserve: </label>
                            ...
                            <div id="DVCat" runat="server" class="col-md-6 form-group">
                                <label class="col-md-4 control-label gtx">Category:</label>
                                <div class="col-md-8 input-group">
                                    <asp:DropDownList ID="DdlCat" runat="server" Width="250px" AutoPostBack="True"   OnSelectedIndexChanged="DdlCat_SelectedIndexChanged">
                            ...
                            <div id="DvOpt" runat="server" visible="false">
                                <div class="col-md-6 form-group">
                                    <label class="col-md-4 control-label gtx">Select Village name:</label>
                                    <div class="col-md-8 input-group">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="col-md-4 control-label gtx">Option:</label>
                                    <div class="col-md-8 input-group">
                                        <asp:DropDownList ID="ddlselectscheme" runat="server" AutoPostBack="True"  Width="250px">
