<%@ Page Title="Village Relocation Family Data:NTCA" Language="C#" MasterPageFile="~/Mainsite.master" AutoEventWireup="true" CodeFile="FamilyDetail2.aspx.cs" Inherits="ReportGP_FamilyDetail2" %>
...
<div class=" Compliance_table">
	...
	<tr class="bgtrans">
                    <td align="right" width="100%">
                        ...
                        <asp:Button ID="btn_print" class="btn btn-primary btn-sm" runat="server" Text="Print"  Width="70px" OnClick="btn_print_Click1" />
                        <asp:Button ID="ImageButton1" class="btn btn-primary btn-sm" runat="server"  Text="Back" OnClientClick="javascript:window.close();" /></td>
                </tr>
                    <tr>
   ...
   <tr>
        ...
        <table id="Table1" align="center"  class="table-2"   border="0" cellpadding="0" cellspacing="0" width="100%"  >
            <tr>
                ...
                <div >
                    <asp:GridView ID="gv_FamilySearch" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                       ...
                       <asp:Label ID="NoDataFound" runat ="server" Text ="No Record Found" ></asp:Label>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="S No.">
                              ...
                              <a href="FamilyHeadDetail.aspx?F_ID=<%# DataBinder.Eval(Container.DataItem, "FMLY_ID") %>" target="_blank"  style="color:#3F5E1B; color:blue; text-decoration:underline;">
                            ...
                            <asp:TemplateField HeaderText="Relocation Status" >
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                   <asp:Label ID="restatus" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "relocation")%>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Option Selected">
                             ...
                             <asp:TemplateField HeaderText="Family Member">
                                ...
                                <ItemTemplate>
                                      ...
                                      <asp:HyperLink ID="HyperLink1" ForeColor="Blue" Font-Underline="true" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "FMLY_NO_MEMB")%>'
                                      
                                            NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"FMLY_ID","~/ReportGPAdminMaster/FamilyMemberDetail2.aspx?id={0}" ).ToString()+ "&vid="+Request.QueryString["V_ID"] %>' 
                                        Target="_blank"> 
                                      </asp:HyperLink>
